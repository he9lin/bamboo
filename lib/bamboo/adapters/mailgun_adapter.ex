defmodule Bamboo.MailgunAdapter do
  ...
  defp put_custom_vars(body, %Email{attachments: [_|_]}), do: body
  ...
  defp put_tags(body, %Email{attachments: [_|_]}), do: body
  ...
  defp filter_non_empty_mailgun_fields(%{attachments: _} = map), do: map
  defp filter_non_empty_mailgun_fields(map) do
